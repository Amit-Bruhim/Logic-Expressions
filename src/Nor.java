...
/**
 * class Nor is the operand that return false if at least one expression
 * is true.
 */
public class Nor extends BinaryExpression {

    // constructor
    protected Nor(Expression leftExpression, Expression rightExpression) {
    ...
    public Expression nandify() {
        ...
        b = b.nandify();
        return new Nand(new Nand(new Nand(a, a), new Nand(b, b)),
    ...
    public String toString() {
        return "(" + this.getLeftExpression().toString() + " V " + this.getRightExpression() + ")";
    }
}
